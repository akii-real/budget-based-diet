 ...
 * Header Component
 *
 * A responsive navigation header component that includes a logo, navigation links,
 * and a mobile menu. The component handles both desktop and mobile views with a
